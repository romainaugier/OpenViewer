    ...
    def requirements(self):
        ...
        if self.options.with_opencolorio:
            if tools.Version(self.version) < "2.3.7.2":
                ...
                self.requires("opencolorio/2.1.0@openviewer/1.0")
...
""")
    ...
    def source(self):
        tools.download("https://github.com/OpenImageIO/oiio/archive/refs/tags/v2.4.4.2.zip", "oiio-2.4.4.2.zip")
        
        tools.unzip("oiio-2.4.4.2.zip", self._source_subfolder, strip_root=True)
